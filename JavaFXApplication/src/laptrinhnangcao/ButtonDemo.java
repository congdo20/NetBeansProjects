...
public class ButtonDemo extends Application {
    ...
    protected BorderPane getPane() throws FileNotFoundException {
        ...
        ImageView imgLeft = new ImageView(new Image(new FileInputStream("C:\\Users\\donct\\Pictures\\luigi.png")));
        ImageView imgRight = new ImageView(new Image(new FileInputStream("C:\\Users\\donct\\Pictures\\luigi.png")));
